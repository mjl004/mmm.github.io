...
!function(t, e) {
                ...
                if ("string" != typeof s) {
                    ...
                    if (zt(f)) {
                        ...
                        for (var h = 0; h < f.length; h++) {
                            if (p = u(f[h]),
                            !e[c].test(p))
                                throw new TypeError('Expected all "' + s.name + '" to match "' + s.pattern + '", but received `' + JSON.stringify(p) + "`");
                            o += (0 === h ? s.prefix : s.delimiter) + p
                        }
                    } else {
                        if (p = s.asterisk ? R(f) : u(f),
                        !e[c].test(p))
                            throw new TypeError('Expected "' + s.name + '" to match "' + s.pattern + '", but received "' + p + '"');
                        o += s.prefix + p
                    }
                } else
                    o += s
    ...
    function q(t, e, n) {
        ...
        return r || (i = (f ? i.slice(0, -p.length) : i) + "(?:" + p + "(?=$))?"),
        i += o ? "$" : r && f ? "" : "(?=" + p + "|$)",
        C(new RegExp("^" + i,_(n)), e)
    }
    function L(t, e, n) {
        return zt(e) || (n = e || n,
        e = []),
        n = n || {},
        t instanceof RegExp ? T(t, e) : zt(t) ? $(t, e, n) : S(t, e, n)
    }
    function P(t) {
        var e, n, r = Dt[t];
        return r ? (e = r.keys,
    ...
    function z(t, e, r) {
        ...
        if (!o.path && o.params && e) {
            o = M({}, o),
            o._normalized = !0;
            var i = M(M({}, e.params), o.params);
            if (e.name)
                o.name = e.name,
                o.params = i;
            else if (e.matched) {
                var a = e.matched[e.matched.length - 1].path;
                o.path = U(a, i, "path " + e.path)
            }
            return o
        }
        var u = v(o.path || "")
    ...
    function V(e) {
        ...
        function r(t, e, n) {
            ...
            if (o) {
                ...
                if (i)
                    return r.path = U(i.path, r.params, 'named route "' + o + '"'),
                    u(i, r, n)
            } else if (r.path) {
                r.params = {};
                for (var f in s)
                    if (B(f, r.params, r.path))
                        return u(s[f], r, n)
            }
            return u(null, r)
        }
        function o(e, n) {
            ...
            var c = a
              ...
              , l = n.hash
              , d = n.params;
            if (h = c.hasOwnProperty("query") ? c.query : h,
            ...
            if (f) {
                var y = H(f, e)
                  , v = U(y, d, 'redirect route with path "' + y + '"');
                return r({
                    _normalized: !0,
                    path: v,
                    query: h,
            ...
            return t(!1, "invalid redirect option: " + JSON.stringify(a)),
            u(null, n)
        }
        function a(t, e, n) {
    ...
    function B(t, e, n) {
        ...
        if (!e)
            return !0;
        for (var u = 1, c = a.length; u < c; ++u) {
            var s = i[u - 1]
              , p = "string" == typeof a[u] ? decodeURIComponent(a[u]) : a[u];
            s && (e[s.name] = p)
        }
        return !0
    }
            ...
            if ("function" == typeof e && !e.options)
                return function(n, i, a) {
                    var u = yt(function(t) {
                      ...
                      , c = yt(function(e) {
                        t(!1, "Failed to resolve async component " + o + ": " + e),
                        a(!1)
                    })
                      , s = e(u, c);
                    s && "function" == typeof s.then && s.then(u, c)
                }
        })
    }
    function lt(t, e) {
    ...
    var Ot, Rt = {
        ...
        render: function(t, n) {
            var r = n.props
              ...
              , a = n.data;
            a.routerView = !0;
            for (var u = r.name, c = i.$route, s = i._routerViewCache || (i._routerViewCache = {}), p = 0, f = !1; i; )
            ...
            ,
            a.props = e(c, h.props && h.props[u]),
            t(l, a, o)
        }
    }, Et = /[!'()*]/g, jt = function(t) {
        return "%" + t.charCodeAt(0).toString(16)
    }, At = /%2C/g, Ct = function(t) {
        return encodeURIComponent(t).replace(Et, jt).replace(At, ",")
    }, _t = decodeURIComponent, Tt = /\/?$/, $t = i(null, {
        path: "/"
    }), St = [String, Object], qt = [String, Array], Lt = {
        name: "router-link",
        props: {
            to: {
                type: St,
        ...
        render: function(t) {
            ...
            if ("a" === this.tag)
                ...
                var w = l(this.$slots.default);
                if (w) {
                    w.isStatic = !1;
                    var b = Ot.util.extend
                      , x = w.data = b({}, w.data);
                    x.on = m;
                    var k = w.data.attrs = b({}, w.data.attrs);
                    k.href = s
                } else
                    g.on = m
            }
    ...
    }, Pt = "undefined" != typeof window, Ut = Array.isArray || function(t) {
        return "[object Array]" == Object.prototype.toString.call(t)
    }
    , zt = Ut, Mt = L, Vt = x, Bt = k, Ht = E, It = q, Ft = new RegExp(["(\\\\.)", "([\\/.])?(?:(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?|(\\*))"].join("|"),"g");
    Mt.parse = Vt,
    Mt.compile = Bt,
    Mt.tokensToFunction = Ht,
    Mt.tokensToRegExp = It;
    ...
    Wt.prototype.confirmTransition = function(t, e, n) {
        ...
        if (c(t, o) && t.matched.length === o.matched.length)
            return this.ensureURL(),
            i();
        var a = rt(this.current.matched, t.matched)
          , u = a.updated
          , s = a.deactivated
          , p = a.activated
        ...
        var h = function(e, n) {
            return r.pending !== t ? i() : void e(t, o, function(t) {
                t === !1 ? (r.ensureURL(!0),
                i()) : "string" == typeof t || "object" == typeof t ? ("object" == typeof t && t.replace ? r.replace(t) : r.push(t),
                i()) : n(t)
            })
        };
        et(f, h, function() {
            var n = []
              ...
              , a = st(p, n, o);
            et(a, h, function() {
                return r.pending !== t ? i() : (r.pending = null,
                e(t),
                void (r.router.app && r.router.app.$nextTick(function() {
    ...
    var Gt = function(t) {
      ...
      , te = function(t) {
        ...
        this.beforeHooks = [],
        this.afterHooks = [],
        this.matcher = V(t.routes || []);
        var e = t.mode || "hash";
        switch (this.fallback = "history" === e && !Nt,
    ...
    te.install = d,
    te.version = "2.3.1",
    Pt && window.Vue && window.Vue.use(te),
    te
});